 ...
 * 2016-09-06T11:06:34.265+03:00
 * Generated source version: 3.1.6
 * 
 */
@WebServiceClient(name = "CxSDKWebService", 
                  wsdlLocation = "file:/C:/cxdev/source/cxmavenplugin/Maven-Plugin/src/main/resources/WEB-INF/CxSDKWebService.wsdl",
...
public class CxSDKWebService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/cxdev/source/cxmavenplugin/Maven-Plugin/src/main/resources/WEB-INF/CxSDKWebService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CxSDKWebService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/cxdev/source/cxmavenplugin/Maven-Plugin/src/main/resources/WEB-INF/CxSDKWebService.wsdl");
        }
        WSDL_LOCATION = url;
    }
