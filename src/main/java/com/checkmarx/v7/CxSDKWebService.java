 ...
 * 2016-08-23T15:34:02.932+03:00
 * Generated source version: 3.1.6
 * 
 */
@WebServiceClient(name = "CxSDKWebService", 
                  wsdlLocation = "file:/C:/cxdev/source/cxmavenplugin/Checkmarx-Maven-Plugin/src/main/resources/WEB-INF/CxSDKWebService.wsdl",
...
public class CxSDKWebService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/cxdev/source/cxmavenplugin/Checkmarx-Maven-Plugin/src/main/resources/WEB-INF/CxSDKWebService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CxSDKWebService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/cxdev/source/cxmavenplugin/Checkmarx-Maven-Plugin/src/main/resources/WEB-INF/CxSDKWebService.wsdl");
        }
        WSDL_LOCATION = url;
    }
